...
法令は改正されます。本書は法律相談を目的とせず、具体的な取扱いは組織の法務・コンプライアンス部門や専門家へ確認する前提です。
...
- [ISO/IEC 11179 Metadata registries（ISO検索）](https://www.iso.org/search.html?q=ISO%2FIEC%2011179)

標準本文には有償・著作権保護されたものがあります。本書では公開された概要や公式紹介ページを参照し、標準本文を転載しません。
...
DAMA-DMBOKやEDM Councilの成果物は有用な参考資料ですが、それぞれの利用条件が適用されます。本書は名称や一般的な概念を参照するにとどめ、図表・定義・本文を無断転載しません。

## 引用とライセンス

- 本書独自の文章・図表・問題：MIT License
- リンク先の第三者著作物：各権利者の条件
...
- **公式範囲**：シラバス案に明記された内容
- **公式問題から確認できる傾向**：サンプル問題と出題趣旨から読み取れる内容
- **本書の学習上の補足**：理解を助けるために追加した説明や例

正式シラバス公開後は「案」と確定情報を混在させないように更新します。
